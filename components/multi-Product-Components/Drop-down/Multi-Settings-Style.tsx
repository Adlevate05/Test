...
export default function MultiSettingsStyle({
  products = [],
}: {
  ...
  const {
    ...
    selectedStyle,
    setSelectedStyle,
    cardsBackground, setCardsBackground,
    selectedBackground, setSelectedBackground,
    borderColor, setBorderColor,
    blockTitleColor, setBlockTitleColor,
    titleColor, setTitleColor,
    subtitleColor, setSubtitleColor,
    priceColor, setPriceColor,
    fullPriceColor, setFullPriceColor,
    labelBackground, setLabelBackground,
    labelText, setLabelText,
    badgeBackground, setBadgeBackground,
    badgeText, setBadgeText,
    blockTitleFontSize, setBlockTitleFontSize,
    blockTitleFontStyle, setBlockTitleFontStyle,
    ...
    labelFontStyle, setLabelFontStyle,
  ...
  type PickerMode = "specific" | "except" | null;
  const [pickerMode, setPickerMode] = useState<PickerMode>(null);
  const [tempSelectedIds, setTempSelectedIds] = useState<string[]>([]);

  // Build quick lookup for titles
    ...
    try {
      ...
      if (selection) {
        ...
        switch (type) {
          case "specific":
          case "viewSpecific":
            setPrimarySpecificIds(selectedIds);
            break;
          case "except":
          case "viewExcept":
            setPrimaryExceptIds(selectedIds);
            break;
        }
      } else if (type === "viewSpecific" || type === "viewExcept") {
        // If user cancels in view mode, keep the original selection
  ...
  return (
    <Box>
              ...
              <BlockStack gap="300">
                ...
                <div className="mt-8">
                  ...
                  <div className="mt-7">
                    ...
                    {/* Badge texts */}
                    {selectedStyle == 0 && (<div className="mt-5">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            <input
                              ...
                              onChange={(e) => setBadgeBackground(e.target.value)} // <- updated
                              className="w-8 h-8 border-none bg-none"
                            />
      ...
      {/* ===== Product Picker Modal (Polaris portal; doesn't disturb layout) ===== */}
      <Modal
        ...
        primaryAction={{ content: "Select", onAction: confirmPicker }}
      ...
      >
        <Modal.Section>
          <ResourceList
            ...
            onSelectionChange={(ids) => setTempSelectedIds(ids as string[])}
            selectable
            renderItem={({
              id,
              title,
