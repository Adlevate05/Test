...
import { parseBogoOptions, toAppContextInitial, toBlockStyle } from "app/utils/helpers";
...
export const loader = async ({ request, params }: LoaderFunctionArgs) => {
  ...
  const options = parseBogoOptions(existing?.configuration_block_options);
...
export const action = async ({ request, params }: ActionFunctionArgs) => {
  ...
  try {
    await service.update("bogo", dto, numericId);
    return redirect("/app");
  } catch (e: any) {
    return json(
...
// ---- page wrapper ----
export default function BogoDealEdit() {
  ...
  return (
    <AppProvider initialState={initialState}>
      <BogoDealForm mode="edit" id={bundleId} />
    </AppProvider>
  );
}
